<script>
    ...
    import { createNotificationModal, fetchAllNotifications, fetchNotificationsUser } from '../lib/scripts/notificationControllers/notificationsA.controller.js';
                ...
                <div class="body">
                    ...
                    <section class="layout-inside-deliveries">
                        <div class="header-deliveries">
                            <div class="header-05">
                                <div class="frame-56">
                                    <button class="button2" on:click={() => createNotificationModal()}>
                                        <div class="text-container2">
                                            <div class="button-text2">Crear una notificacion</div>
                                        </div>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="main-deliveries">
                            <div class="grow1 fixed-size">
                                <h3 class="delivery-title">Notificaciones</h3>
