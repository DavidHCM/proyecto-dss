<script>
    ...
    import { fetchIncidentsOpen, handleDeleteIncident, handleEditIncident, fetchAllIncidents } from '../lib/scripts/incidentsControllers/incidentsA.controller.js'
    import { fetchIncidentsOpenS } from '../lib/scripts/incidentsControllers/incidentsS.controller.js'
    import { fetchByDriver, addIncident } from '../lib/scripts/incidentsControllers/incidentsD.controller.js'
    ...
    async function loadIncidents() {
        if (selectedFilter === 'open') {
            await fetchIncidentsOpen();
        } else {
            await fetchAllIncidents();
        }
    }

    function handleIncidentButtonClick(event) {
    ...
    {#if isAuthenticated}
        {#if userType === 'admin'}
            <section class="layout">
                ...
                <div class="leftSide">
                    <div class="dashboard-sidebar">
                        <div class="frame">
                            ...
                            <button class="content" on:click={() => change('incidents')}>
                                <div class="icon">
                ...
                <div class="body">
                    <section class="layout-inside-incidents">
                        <div class="header-incidents">
                            <div class="header-05">
                                <div class="frame-56">
                                    <button class="button2" on:click="{fetchIncidentsOpen}">
                                        <div class="text-container2">
                                            <div class="button-text2">Refrescar Incidentes</div>
                                        </div>
                                    </button>
                                </div>
                            </div>
                            <div class="filter-options">
                                <label class="radio-container">
                                    <input type="radio" name="incidentFilter" value="open" bind:group={selectedFilter} on:change={loadIncidents} checked>
                                    <span class="custom-radio"></span>
                                    Incidentes Abiertos
                                </label>
                                <label class="radio-container">
                                    <input type="radio" name="incidentFilter" value="all" bind:group={selectedFilter} on:change={loadIncidents}>
                                    <span class="custom-radio"></span>
                        ...
                        <div class="main-incidents">
                            <div class="grow1 fixed-size-incidents">
                                <h3 class="incident-title">Incidentes</h3>
                                <ul class="incident-list-container" on:click="{handleIncidentButtonClick}"></ul>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <div class="body">
                    <section class="layout-inside-incidents">
                        <div class="header-incidents">
                            <div class="header-05">
                                <div class="frame-56">
                                    <button class="button2" on:click="{addIncident}">
                                        <div class="text-container2">
                                            <div class="button-text2">Agregar Incidentes</div>
                                        </div>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="main-incidents">
                            <div class="grow1 fixed-size">
                                <h3 class="incident-title">Incidentes</h3>
                                <ul class="incident-list-container" ></ul>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <div class="body">
                    <section class="layout-inside-incidents">
                        <div class="header-incidents">
                            <div class="header-05">
                                <div class="frame-56">
                                    <button class="button2" on:click="{fetchIncidentsOpenS}">
                                        <div class="text-container2">
                                            <div class="button-text2">Refrescar Incidentes</div>
                                        </div>
                                    </button>
